...
_Arg1("_Arg1", 2D) = "black" {}
_Emission("_Emission", 2D) = "black" {}
_Arg2("_Arg2", Float) = 1
_Diffuse("_Diffuse", Color) = (0.2784386,0.4600956,0.7573529,1)
